 ...
 */
export const findMainCharacterGroup = (root: HTMLElement | null): SVGGElement | null => {
    if (!root) return null
 ...
 */
export const hideStrokeElement = (group: SVGGElement | null, strokeIndex: number): (() => void) | null => {
